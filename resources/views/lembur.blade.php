<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="basis-1/2 relative">
            ...
            <a href={{ route('lembur.tambah') }} class="text-gray-400 hover:text-gray-100 mr-2">
                <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-1 text-center mr-2 -mb-2">Tambah</button>
            </a>
            </div>
        </div>
    </x-slot>
