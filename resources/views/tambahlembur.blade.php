                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form>
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <input type="text" id="disabled-input" name="disabled-input" aria-label="disabled input"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="search" id="default-search"
                                    ...
                                    placeholder="Surat Perintah Lembur" required>
                                <button type="submit"
